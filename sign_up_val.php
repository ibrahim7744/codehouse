...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($password)) {
        ...
        $_SESSION['password_error'] = "*The password must be at lest 5 numbers";
    }
    ...
    if (!(isset($_SESSION['firstname_error']) || isset($_SESSION['lastname_error']) || isset($_SESSION['email_error']) || isset($_SESSION['password_error']) || isset($_SESSION['confirm_password_error']))) {
        //insert query
